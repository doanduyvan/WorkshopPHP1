						...
						<div class="top_nav_right">
							<ul class="top_nav_menu">
								...
								<li class="account">
									...
									<ul class="account_selection">
										<li><a href="public?page=login"><i class="fa fa-sign-in" aria-hidden="true"></i>Sign In</a></li>
										<li><a href="public?page=register"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</a></li>
									</ul>
								</li>
                                        <?php
                                    }
